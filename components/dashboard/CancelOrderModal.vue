<template>
  <div class="dashboard-modal">
    <modal :name="cancelOrder">
      ...
      <!-- <div class="pb-5">
        <div class="text-end">
          <button @click="closeModal('cancel-order')" class="btn brand-color"><i class="fa-solid fa-xmark"></i></button>
        </div>
