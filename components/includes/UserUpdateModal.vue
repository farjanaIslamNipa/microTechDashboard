                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group">
                                <div class="">
                                    ...
                                    <input v-model="putUserData.first_name" disabled type="text" class="form-control " placeholder="Enter first name" readonly />
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group">
                                <div class="">
                                    ...
                                    <input v-model="putUserData.last_name" disabled type="text" class="form-control " placeholder="Enter last name" readonly />
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group">
                                <div class="">
                                    ...
                                    <input v-model="putUserData.phone_number" type="tel" class="form-control " placeholder="ie. 0412345678" :disabled="(userData.phoneNumber === '' || userData.phoneNumber === null ) ? false : true" />
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group">
                                <div class="">
                                    ...
                                    <input v-model="putUserData.email" type="email" :disabled="(userData.email === '' || userData.email === null ) ? false : true" class="form-control " placeholder="ie. example@gmail.com" />
